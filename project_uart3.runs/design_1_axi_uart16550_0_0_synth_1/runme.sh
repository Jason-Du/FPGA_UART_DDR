...
HD_PWD='D:/0FPGA/project_uart3/project_uart3.runs/design_1_axi_uart16550_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_uart16550_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_uart16550_0_0.tcl
